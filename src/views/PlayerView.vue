...
import type { DBPlayer, PlayerBrawler } from '@/shared/models/player.model'
...
const player = ref<DBPlayer | null>(null)
  ...
  <div v-if="player" class="content">
    <div class="max-w-screen-xl mx-auto text-white px-3">
      ...
      <div class="grid md:grid-cols-2 gap-2 my-2">
        ...
        <PlayerStatsTopBrawler :topBrawler="topBrawler" :brawlers="brawlers" />
