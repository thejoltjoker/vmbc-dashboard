...
import type { PlayerBrawler } from '@/shared/models/player.model'

defineProps<{
  topBrawler: PlayerBrawler | null
  brawlers: Brawler[]
}>()
</script>
...
<template>
  <PlayerStatsBox>
    <template #title> Top brawler </template>
    <template #subtitle>
      <span class="text-white">
        {{ topBrawler?.trophies ?? 0 }}
      </span>
      Trophies
    </template>
    <template #content>
