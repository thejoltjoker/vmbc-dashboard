...
<template>
  <PlayerStatsBox>
    <template #title> Trophies </template>
    <template #subtitle v-if="player.trophies < player.highestTrophies">
    ...
    <template #content>
      <p>{{ player.trophies.toLocaleString() ?? 0 }}</p>
    </template>

    <template #svg v-if="player.trophies < player.highestTrophies">
